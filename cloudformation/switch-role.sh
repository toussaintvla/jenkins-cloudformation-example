...
full_temp_file_path="/tmp/aws-temp-creds-${the_region}-${date_stamp}"

aws sts assume-role --role-arn ${the_role} --role-session-name switchedrole${date_stamp} --region ${the_region} > ${full_temp_file_path}
